...
def structure_to_cells(table_structure, tokens):
    ...
    for column_num, column in enumerate(columns):
        for row_num, row in enumerate(rows):
            ...
            #     if cell_rect.x0 > cell_rect.x1:
            #         cell_rect.x0, cell_rect.x1 = cell_rect.x1, cell_rect.x0
            #     elif cell_rect.x1 == cell_rect.x0 == 0:
            #         cell_rect.x1 = cell_rect.x0 + 1
            #     if cell_rect.y0 > cell_rect.y1:
            #         cell_rect.y0, cell_rect.y1 = cell_rect.y1, cell_rect.y0
            #     elif cell_rect.y1 == cell_rect.y0 == 0:
            #         cell_rect.y1 = cell_rect.y0 + 1
